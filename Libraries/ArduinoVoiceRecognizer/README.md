# VoiceRecognizer library #
The VoiceRecognizer library provides an interface for voice recognition using the Arduino. It currently produces phonemes, often the library will produce junk phonemes. Please bare with it for the time being. A noise removal function is underway.
...
Head over to the [github](https://github.com/rosarioconti) and you will find most of the documentation required.
...
- [Return to main page](https://github.com/rosarioconti)
